...
def main(input_file, track_mode, filter_option, association_type):
    ...
    for group_idx, group in enumerate(measurement_groups):
        ...
        if len(group) == 1:  # Single measurement
            ...
            assigned_reports = set(tuple(best_report) for _, best_report in best_reports)
            for report in reports:
...
class KalmanFilterGUI(QWidget):
    ...
    def initUI(self):
        ...
        left_layout.addWidget(self.file_upload_button)
        ...
        self.system_config_group = QGroupBox("System Configuration")
        ...
        # Filters Mode
        self.filter_group = QGroupBox("Filters Mode")
        ...
        self.range_vs_time_button = QPushButton("Range vs Time")
        visualization_layout.addWidget(self.range_vs_time_button)
        self.azimuth_vs_time_button = QPushButton("Azimuth vs Time")
        visualization_layout.addWidget(self.azimuth_vs_time_button)
        self.elevation_vs_time_button = QPushButton("Elevation vs Time")
        visualization_layout.addWidget(self.elevation_vs_time_button)
        ...
        # # Plot Settings Group
        # self.plot_settings_group = QGroupBox("Plot Settings")
        ...
        # self.max_range_edit = QLineEdit()
        # self.max_range_edit.setPlaceholderText("Max")
        # plot_settings_layout.addWidget(self.range_label, 0, 0)
        # plot_settings_layout.addWidget(self.min_range_edit, 0, 1)
        # plot_settings_layout.addWidget(self.max_range_edit, 0, 2)
        ...
        # self.max_azimuth_edit = QLineEdit()
        # self.max_azimuth_edit.setPlaceholderText("Max")
        # plot_settings_layout.addWidget(self.azimuth_label, 1, 0)
        # plot_settings_layout.addWidget(self.min_azimuth_edit, 1, 1)
        # plot_settings_layout.addWidget(self.max_azimuth_edit, 1, 2)
        ...
        # self.max_elevation_edit = QLineEdit()
        # self.max_elevation_edit.setPlaceholderText("Max")
        # plot_settings_layout.addWidget(self.elevation_label, 2, 0)
        # plot_settings_layout.addWidget(self.min_elevation_edit, 2, 1)
        # plot_settings_layout.addWidget(self.max_elevation_edit, 2, 2)
        ...
        # self.max_time_edit = QLineEdit()
        # self.max_time_edit.setPlaceholderText("Max")
        # plot_settings_layout.addWidget(self.time_label, 3, 0)
        # plot_settings_layout.addWidget(self.min_time_edit, 3, 1)
        # plot_settings_layout.addWidget(self.max_time_edit, 3, 2)
    ...
    def plot_measurements(self, tracks, plot, plot_type, selected_track_ids=None):
        for track in tracks:
            ...
            # Plot Sf values starting from the third measurement
            if len(track['Sf']) > 2:
                Sf_x = [state[0, 0] for state in track['Sf'][2:]]  # Ensure correct indexing
                Sf_y = [state[1, 0] for state in track['Sf'][2:]]
                Sf_z = [state[2, 0] for state in track['Sf'][2:]]
                Sf_times = times[2:]
            else:
                Sf_x, Sf_y, Sf_z, Sf_times = [], [], [], []
            ...
            if plot_type == "Range vs Time":
                ...
                plot.plot(Sf_times, Sf_x, pen=plot_color, symbol='x', symbolSize=marker_size, symbolBrush=plot_color, name=f'Track {track["track_id"]} Sf X')
                ...
                plot.plot(Sf_times, Sf_y, pen=plot_color, symbol='x', symbolSize=marker_size, symbolBrush=plot_color, name=f'Track {track["track_id"]} Sf Y')
                ...
                plot.plot(Sf_times, Sf_z, pen=plot_color, symbol='x', symbolSize=marker_size, symbolBrush=plot_color, name=f'Track {track["track_id"]} Sf Z')
