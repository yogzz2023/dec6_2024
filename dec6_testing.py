...
class KalmanFilterGUI(QWidget):
    ...
    def initUI(self):
        ...
        # Top controls for plot configuration
        ...
        top_controls_layout.addWidget(self.plot_config_button)
        ...
        top_controls_layout.addWidget(self.plot_color_label)
        top_controls_layout.addWidget(self.plot_color_combo)
        ...
        top_controls_layout.addWidget(self.marker_size_label)
        top_controls_layout.addWidget(self.marker_size_combo)

        # Clear Plot button
        self.clear_plot_button = QPushButton("Clear Plot")
        self.clear_plot_button.clicked.connect(self.clear_plot)
        top_controls_layout.addWidget(self.clear_plot_button)

        # Console button
        self.console_button = QPushButton("Console")
        self.console_button.clicked.connect(self.show_console)
        top_controls_layout.addWidget(self.console_button)
        ...
        self.output_display.setVisible(False)  # Initially hide the console
